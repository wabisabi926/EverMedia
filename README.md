...
| **计划任务 - 线程数量** (`MaxConcurrency`) | 同时刷新媒体信息的线程数量，例如： 2就是同时刷新2个项目。 |
| **计划任务 - .strm 访问间隔（秒）** (`BootstrapTaskRateLimitSeconds`)| 任务刷新的间隔，例如：2就是2个项目之间最少要间隔2秒。0就是没有限制。请根据自己的情况定义，默认偏保守。 |
